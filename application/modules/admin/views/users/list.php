...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?=$this->lang->line('user_module_title')?></li>
        </ol>
    </section>
                    ...
                    <div class="box-body">
                        <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                            ...
                            <div class="row">
                               ...
                               <div class="col-sm-1">
                                    <label>
                                        <button class="btn btn-danger howler" data-type="danger" title="Delete" onclick="activatpopup('0','inactive','');"><?=$this->lang->line('common_delete_title')?></button>
                                    </label>
                                </div>
