...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?=$this->lang->line('admin_user_module_title')?></li>
        </ol>
    </section>
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><?=$this->lang->line('admin_user_module_title')?></h3>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                            ...
                            <div class="row">
                                <div class="col-sm-1">
                                    <label>
                                        <button class="btn btn-danger howler" data-type="danger" title="Delete" onclick="deletepopup('0','');"><?=$this->lang->line('common_delete_title')?></button>
                                    </label>
                                </div>
                                <div class="col-sm-1">
                                    <label>
                                        <button class="btn btn-primary howler" data-type="danger" title="Delete" onclick="statuspopup('0','1','');"><?=$this->lang->line('common_label_activa')?></button>
                                    </label>
                                </div>
                                <div class="col-sm-1">
                                    <label>
                                        <button class="btn btn-primary howler" data-type="danger" title="Delete" onclick="statuspopup('0','0','');"><?=$this->lang->line('common_label_inactiva')?></button>
                                    </label>
                                </div>
