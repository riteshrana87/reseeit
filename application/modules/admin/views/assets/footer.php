...
<aside class="control-sidebar control-sidebar-dark">
  ...
  <!-- AdminLTE App -->
  <script type="text/javascript" src="<?=$this->config->item('admin_js_path')?>app.min.js"></script> 

  <!-- Block ui-->
  <script type="text/javascript" src="<?=$this->config->item('js_path');?>jquery.blockUI.js"></script>
  <script type="text/javascript" src="<?=$this->config->item('admin_js_path');?>demo.js"></script>
