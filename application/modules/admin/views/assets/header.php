...
<head>
    ...
    <!-- image show on fancybox -->
    <script type="text/javascript" src="<?=$this->config->item('js_path');?>jquery.mousewheel-3.0.6.pack.js"></script>

    <!-- Add fancyBox main JS and CSS files -->
    <script type="text/javascript" src="<?=$this->config->item('js_path');?>jquery.fancybox.js?v=2.1.5"></script>
    <link rel="stylesheet" type="text/css" href="<?=$this->config->item('css_path');?>jquery.fancybox.css?v=2.1.5" media="screen" />

    <!-- Add Button helper (this is optional) -->
    <link rel="stylesheet" type="text/css" href="<?=$this->config->item('css_path');?>jquery.fancybox-buttons.css?v=1.0.5" />
    <script type="text/javascript" src="<?=$this->config->item('js_path');?>jquery.fancybox-buttons.js?v=1.0.5"></script>

    <!-- Add Thumbnail helper (this is optional) -->
    <link rel="stylesheet" type="text/css" href="<?=$this->config->item('css_path');?>jquery.fancybox-thumbs.css?v=1.0.7" />
    <script type="text/javascript" src="<?=$this->config->item('js_path');?>jquery.fancybox-thumbs.js?v=1.0.7"></script>

    <!-- Add Media helper (this is optional) -->
    <script type="text/javascript" src="<?=$this->config->item('js_path');?>jquery.fancybox-media.js?v=1.0.6"></script>
