...
class Client_account extends CI_Controller {
    ...
    public function index($data='')
    {
        ...
        $fields = array('u.user_id', 'u.role_id', 'u.username', 'u.email', 'u.user_img', 'u.activated', 'u.fullname', 'u.register_type','u.last_name','u.first_name','rl.role_name','co.com_id','co.com_name','cl.address','cl.	com_location_id','cl.state','cl.city','cl.zipcode','u.phone_number');
...
//pr($data['user_cdata']);exit;
        ...
        $this->load->view('client_account', $data);
    }
   ...
   */
    ...
    public function check_user()
    {
        ...
        $match=array('email'=>$email,'activated'=>'active','role_id' =>3);
