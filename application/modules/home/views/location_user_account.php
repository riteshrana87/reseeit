    ...
    <div class = "container-fluid">
        ...
        <div class = "row header-reg headerPanel-nvt">
            ...
            <div class = "col-sm-12 col-md-6 col-lg-5">
                <p class="col-sm-5 col-md-12 plat-greet" style="display: inline;" id="client-greeting">Hello <?php
        ...
        <div class="row outer1 display-yes" id="loyaltyInteractions">
            <div class="mainBody col-sm-12 col-lg-10 col-lg-offset-1" style="color: black; text-align: left; font-size:0.8em; height: 615px;">
                ...
                <form id="form-inAppAds" method="post"
                      action="<?php echo base_url(); ?>home/location_user_account/insert_data" ENCTYPE="multipart/form-data">
                    <?php }else{?>
                    <form id="form-inAppAds" method="post"
                          action="<?php echo base_url(); ?>home/location_user_account/update_data" ENCTYPE="multipart/form-data">
                        <?php }?>
                    <div class="row inner1">
                        ...
                        <div class = "col-xs-12 col-sm-6 col-sm-offset-3">
                            <div class="right-head" style="margin: 5px 0px 5px 0px">
                                ...
                                <div class="form-group">
                                    <label style="width: 100%" for="locContactFirstName">User Information</label>
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-6 marginTop3">
                                    ...
                                    <input type="email" value="<?php echo $user_session['email'];?>" class="form-control marginTop3" id="locContactEmail" placeholder="Email Address" disabled>
                                    <input type="hidden" name="user_id" value="<?php echo $user_session['user_id'];?>">
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-6">
                                            <input type="number" value="<?=!empty($userlist[0]['phone_number'])?$userlist[0]['phone_number']:''?>" name="phone_number" class="form-control marginTop3" id="clientZip" placeholder="Phone Number" required>
                                        </div>
                                    </div>
                                    </div>
