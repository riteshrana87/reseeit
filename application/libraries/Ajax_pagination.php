      ...
      if ($this->show_count)
      {
		...
		if  ($this->cur_page > $this->num_links)
		{
			$output .= $this->first_tag_open.'<li class="paginate_button previous disabled">'
					. $this->getAJAXlink( '' , $this->first_link).'</li>'
		...
		if (($this->cur_page + $this->num_links) < $num_pages)
		{
			...
			$output .= $this->last_tag_open .'<li class="paginate_button previous disabled">'. $this->getAJAXlink( $i, $this->last_link ).'</li>' . $this->last_tag_close;
		}
